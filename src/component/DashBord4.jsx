    ...
    <section className='bg-[#E4E4E780] p-5'>
       ...
       <div className='flex justify-between items-center max-w-[1300px] mx-auto pt-0 pl-5 flex-col gap-y-4 lg:flex-row'>
        ...
        <div className='flex gap-4 flex-col lg:flex-row'>
            ...
            <button className='bg-[#F26922] text-white lg:px-10 xl:py-3 px-5 py-2 shadow-lg  rounded-xl transition-all hover:bg-orange-500' onClick={NextSection }>Next step</button>
        </div>
